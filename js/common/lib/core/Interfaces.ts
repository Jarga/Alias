...
export interface ITestableWebElement {
    ...
    FindSubElement(subElementProperties: { [key: string]: string }): webdriver.promise.Promise<ITestableWebElement>;
    FindSubElement(subElementProperties: { [key: string]: string }, timeout: number): webdriver.promise.Promise<ITestableWebElement>;
    ...
    FindSubElements(subElementProperties: { [key: string]: string }): webdriver.promise.Promise<ITestableWebElement[]>;
    FindSubElements(subElementProperties: { [key: string]: string }, timeout: number): webdriver.promise.Promise<ITestableWebElement[]>;
