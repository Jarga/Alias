...
Function Execute_Local_Automation 
{
	...
	$buildXml = [xml]$webclient.DownloadString("http://ostm-build/httpAuth/app/rest/buildTypes/id:TestAutomation_ContinuousBuild/builds/running:false,status:success")
